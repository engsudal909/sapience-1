...
Get started by [deploying a forecasting agent](/builder-guide/guides/forecasting-agent) with just a few clicks, or [continue reading](/user-guide/introduction/glossary) about Sapience.
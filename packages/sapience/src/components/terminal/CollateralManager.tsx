...
const CollateralManager: React.FC = () => {
  ...
  return (
    <div className="border border-border rounded-lg bg-brand-black text-brand-white">
      <div className="p-3 flex items-center justify-between">
        ...
        <button
          type="button"
          className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-border/60 hover:bg-muted/20"
